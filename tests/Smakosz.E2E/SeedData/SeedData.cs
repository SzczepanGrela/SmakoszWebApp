...
public static class SeedData
{
    ...
    public static async Task SeedAsync(SmakoszDbContext db)
    {
        ...
        db.SystemConfigs.AddRange(
            ...
            new SystemConfig { Key = "search.dishes_page_size", Value = "6", Description = "Liczba dan per strona w /search?type=dishes", IsSecret = false, IsPublic = true },
            new SystemConfig { Key = "search.restaurants_page_size", Value = "12", Description = "Liczba restauracji per strona w /search?type=restaurants", IsSecret = false, IsPublic = true },
            new SystemConfig { Key = "admin.list_page_size", Value = "10", Description = "Liczba rekordow per accordion w /admin/users/{id}", IsSecret = false, IsPublic = false },
        ...
        db.SystemNodes.AddRange(
            ...
            new SystemNode { NodeId = "dead-test-node", NodeType = NodeType.Api, Status = "offline", Hostname = "dead-host", IpAddress = "10.0.0.99", LastHeartbeat = DateTime.UtcNow.AddDays(-30) });
