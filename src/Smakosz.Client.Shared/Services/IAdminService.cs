...
public interface IAdminService
{
    ...
    Task<AdminUserDetailDto?> GetUserAsync(Guid publicId);
    ...
    Task<PagedResult<AdminUserReviewDto>?> GetUserReviewsAsync(Guid publicId, int page = 1);
    Task<PagedResult<AdminSecurityLogDto>?> GetUserSecurityLogsAsync(Guid publicId, int page = 1);
    Task<PagedResult<AdminPhotoDto>?> GetUserPhotosAsync(Guid publicId, int page = 1);
    Task<PagedResult<AdminTicketDto>?> GetUserTicketsAsync(Guid publicId, int page = 1);
    Task<PagedResult<AdminUserActionLogDto>?> GetUserActionLogsAsync(Guid publicId, int page = 1);
    Task<PagedResult<AdminUserFollowerDto>?> GetUserFollowersAsync(Guid publicId, int page = 1);
    Task<PagedResult<AdminUserRestaurantClaimDto>?> GetUserRestaurantClaimsAsync(Guid publicId, int page = 1);
    Task<(bool Success, string? ErrorMessage)> ChangeUserEmailAsync(Guid publicId, string newEmail);
    Task<(bool Success, string? ErrorMessage)> ChangeUserUsernameAsync(Guid publicId, string newUsername);
    ...
    Task<AdminSystemNodesResponseDto?> GetSystemNodesAsync();
    Task<(bool Success, string? ErrorMessage)> AddSystemNodeAsync(AddSystemNodeRequest dto);
    Task<bool> DeleteSystemNodeAsync(string nodeId);
