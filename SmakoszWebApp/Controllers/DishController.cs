...
>>>>>>> 0f1335a (Fix MVC compilation and null reference warnings)
                
                // Dania z nowych odkryć
                new DishViewModel { Id = 8, Name = "Korean BBQ Bibimbap", RestaurantName = "Seoul Kitchen", RestaurantId = 7, Price = 47.00m, AverageRating = 9.6, ReviewCount = 34, ImageUrl = "https://placehold.co/300x200/E91E63/white?text=Korean", Tags = new List<string> { "Nowe", "Koreańskie" }, Description="Tradycyjny bibimbap z grillowanym mięsem, świeżymi warzywami i kimchi." },
                new DishViewModel { Id = 9, Name = "Truffle Pasta Carbonara", RestaurantName = "Pasta Perfetta", RestaurantId = 8, Price = 67.00m, AverageRating = 9.8, ReviewCount = 23, ImageUrl = "https://placehold.co/300x200/8BC34A/white?text=Truffle", Tags = new List<string> { "Nowe", "Luksusowe" }, Description="Luksusowa carbonara z czarnymi truflami, boczkiem guanciale i parmezanem Reggiano." },
                
                // Dodatkowe dania z rekomendacji
                new DishViewModel { Id = 10, Name = "Ramen Shoyu Deluxe", RestaurantName = "Noodle House Tokyo", RestaurantId = 5, Price = 48.00m, AverageRating = 9.8, ReviewCount = 87, ImageUrl = "https://placehold.co/600x400/ff6f61/white?text=Ramen", Description="Tradycyjny ramen shoyu z domowym makaronem i aromatycznym bulionem." },
                new DishViewModel { Id = 11, Name = "Sushi Dragon Roll", RestaurantName = "Sushi Master", RestaurantId = 3, Price = 65.00m, AverageRating = 9.6, ReviewCount = 156, ImageUrl = "https://placehold.co/600x400/2196F3/white?text=Sushi", Description="Ekskluzywny roll z węgorzem, krewetką i awokado, podany z sosem unagi." },
                new DishViewModel { Id = 12, Name = "Pad Thai Premium", RestaurantName = "Thai Garden", RestaurantId = 6, Price = 42.00m, AverageRating = 9.4, ReviewCount = 203, ImageUrl = "https://placehold.co/600x400/FFC107/white?text=Thai", Description="Autentyczny pad thai z krewetkami, kiełkami bambusa i orzeszkami ziemnymi." },
                new DishViewModel { Id = 13, Name = "Carbonara Truffle", RestaurantName = "Italiano", RestaurantId = 7, Price = 52.00m, AverageRating = 9.8, ReviewCount = 98, ImageUrl = "https://placehold.co/600x400/4CAF50/white?text=Pasta", Description="Kremowa carbonara z truflami, boczkiem guanciale i świeżym parmezanem." },
                new DishViewModel { Id = 14, Name = "Burger BBQ Supreme", RestaurantName = "Grill Masters", RestaurantId = 8, Price = 45.00m, AverageRating = 9.6, ReviewCount = 234, ImageUrl = "https://placehold.co/600x400/4CAF50/white?text=BBQ", Description="Potężny burger z kotletem BBQ, bekonem, cebulą karmelizowaną i sosem BBQ." },
                new DishViewModel { Id = 15, Name = "Pizza Quattro Formaggi", RestaurantName = "Pizzeria Roma", RestaurantId = 1, Price = 41.00m, AverageRating = 9.2, ReviewCount = 167, ImageUrl = "https://placehold.co/600x400/ff6f61/white?text=Pizza", Description="Pizza z czterema serami: mozzarella, gorgonzola, parmezan i pecorino." },
                new DishViewModel { Id = 16, Name = "Fish & Chips Classic", RestaurantName = "Burgerownia Stacja", RestaurantId = 2, Price = 38.00m, AverageRating = 9.0, ReviewCount = 189, ImageUrl = "https://placehold.co/600x400/2196F3/white?text=Fish", Description="Klasyczne fish & chips z rybą w cieście piwnym i domowymi frytkami." },
                new DishViewModel { Id = 17, Name = "Sushi Salmon", RestaurantName = "Sushi Master", RestaurantId = 3, Price = 32.00m, AverageRating = 9.4, ReviewCount = 145, ImageUrl = "https://placehold.co/600x400/2196F3/white?text=Sushi", Description="Świeży łosoś na sushi rice z wasabi i marynowanym imbirem." },
                new DishViewModel { Id = 18, Name = "Tacos Al Pastor", RestaurantName = "Thai Garden", RestaurantId = 6, Price = 28.00m, AverageRating = 9.2, ReviewCount = 201, ImageUrl = "https://placehold.co/600x400/FFC107/white?text=Tacos", Description="Meksykańskie tacos z marynowaną wieprzowiną, ananasem i cebulą." },
                new DishViewModel { Id = 19, Name = "Pho Bo Vietnam", RestaurantName = "Noodle House Tokyo", RestaurantId = 5, Price = 35.00m, AverageRating = 9.6, ReviewCount = 178, ImageUrl = "https://placehold.co/600x400/4CAF50/white?text=Pho", Description="Tradycyjna wietnamska zupa pho z wołowiną i świeżymi ziołami." },
                new DishViewModel { Id = 20, Name = "Biryani Chicken", RestaurantName = "Thai Garden", RestaurantId = 6, Price = 39.00m, AverageRating = 9.4, ReviewCount = 167, ImageUrl = "https://placehold.co/600x400/FF9800/white?text=Biryani", Description="Aromatyczne biryani z kurczakiem, ryżem basmati i przyprawami." },
                new DishViewModel { Id = 21, Name = "Gyros Greek", RestaurantName = "Italiano", RestaurantId = 7, Price = 26.00m, AverageRating = 9.0, ReviewCount = 198, ImageUrl = "https://placehold.co/600x400/9C27B0/white?text=Gyros", Description="Grecki gyros z wieprzowiną, tzatziki, pomidorami i czerwoną cebulą." },
                new DishViewModel { Id = 22, Name = "Kebab Turkish", RestaurantName = "Grill Masters", RestaurantId = 8, Price = 24.00m, AverageRating = 8.8, ReviewCount = 234, ImageUrl = "https://placehold.co/600x400/795548/white?text=Kebab", Description="Turecki kebab z mięsem z rożna, świeżymi warzywami i sosem czosnkowym." }
            };
        }
